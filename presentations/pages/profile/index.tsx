  ...
  return (
    <>
      ...
      >
        ...
        <p>
          チャレンジすることが好きで、工場勤務８年から転職してプログラマになったので、その時にわかってたらよかったなって言うことをまとめて記事を書いたので
        ...
        <p>
          他にチャレンジしたことは、体をでかくしたい！
          と思って、半年で78kgくらいから103kgくらいまで増量して体を壊しました。
          <Link color="inherit" href="/stretch-before-going-to-bed">
            こちら
            <StarOutline fontSize="small" />
          </Link>
          の記事にもすこし書いてます。学びとしては極端にやりすぎるのはよくないってことです。限界はあります！皆さんも体は壊さないように気をつけてください。
        </p>
        <p>
          副業にもチャレンジしました、あるときはコーディングテストでおちたりしたわけですが、gitのコミットをきれいに書く必要性を学べたり、普段と異なる環境ってのは刺激があってたのしいです！
