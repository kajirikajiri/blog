...
<NotebookList head="まとめ" items={['ひづけを即、入力できる']} />
...
<NotebookList head="まとめ" items={['ブラウザを開かなくてもgithubのurlがコピペできる', 'master, permlink選択が容易', '相手にブランチ切り替えを強要しない', 'コードをコピペで渡した場合よりも付近のコードの把握が容易']} />
